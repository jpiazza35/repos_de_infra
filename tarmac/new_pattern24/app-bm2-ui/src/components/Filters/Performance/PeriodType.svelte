<script>
  ...
  import { performanceFilterStore, PERIOD_TYPES_OPTIONS } from './filters'
...
<div use:clickOutside on:click_outside={handleClickOutside}>
  ...
  >
    Period Type
    <b class="mx-1">{PERIOD_TYPES_OPTIONS.find(option => option.id === $performanceFilterStore.periodType).name}</b>
