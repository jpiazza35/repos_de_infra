...
data "vault_generic_secret" "databricks" {
  path = "devops/datadotworld/databricks"
}

data "vault_generic_secret" "databricks_sp_token" {
  path = "data_platform/prod/databricks/service-principal-tokens/prod-dataworld-service-principal"
}
