...
variable "sonatype_operating_system_family" {
  description = "The operating system family for the sonatype task."
  default     = "LINUX"
  type        = string
}

variable "sonatype_cpu_architecture" {
  description = "cpu architecture for the sonatype task"
  default     = "X86_64"
  type        = string
}

variable "sonatype_app" {}
...
variable "sonatype_acm_arn" {}
variable "sonatype_efs_id" {}
variable "sonatype_efs_access_point_id" {}


# ### INCIDENT BOT
# variable "incident_bot_operating_system_family" {
#   description = "The operating system family for the incident_bot task."
#   default     = "LINUX"
#   type        = string
# }

# variable "incident_bot_cpu_architecture" {
#   description = "cpu architecture for the incident_bot task"
#   default     = "X86_64"
#   type        = string
# }

# variable "incident_bot_app" {}
...
# variable "incident_bot_acm_arn" {}
# variable "incident_bot_efs_id" {}
# variable "incident_bot_efs_access_point_id" {}
