...
output "bootstrap_brokers" {
  ...
  value = compact([
    try(aws_msk_cluster.msk[0].bootstrap_brokers, null),
    try(aws_msk_cluster.msk[0].bootstrap_brokers_sasl_iam, null),
    try(aws_msk_cluster.msk[0].bootstrap_brokers_sasl_scram, null),
    try(aws_msk_cluster.msk[0].bootstrap_brokers_tls, null),
  ])
}
...
output "bootstrap_brokers_plaintext" {
  ...
  value       = try(aws_msk_cluster.msk[0].bootstrap_brokers, null)
}
...
output "bootstrap_brokers_sasl_iam" {
  ...
  value       = try(aws_msk_cluster.msk[0].bootstrap_brokers_sasl_iam, null)
}
...
output "bootstrap_brokers_sasl_scram" {
  ...
  value       = try(aws_msk_cluster.msk[0].bootstrap_brokers_sasl_scram, null)
}
...
output "bootstrap_brokers_tls" {
  ...
  value       = try(aws_msk_cluster.msk[0].bootstrap_brokers_tls, null)
}

output "current_version" {
  description = "Current version of the MSK Cluster used for updates, e.g. `K13V1IB3VIYZZH`"
  value       = try(aws_msk_cluster.msk[0].current_version, null)
}
...
output "zookeeper_connect_string" {
  ...
  value       = try(aws_msk_cluster.msk[0].zookeeper_connect_string, null)
}
...
output "zookeeper_connect_string_tls" {
  ...
  value       = try(aws_msk_cluster.msk[0].zookeeper_connect_string_tls, null)
}

###### VPC Connection
output "vpc_connections" {
  description = "A map of output attributes for the VPC connections created"
  value       = aws_msk_vpc_connection.vpc
}
...
output "configuration_arn" {
  ...
  value       = try(aws_msk_configuration.config[0].arn, null)
}

output "configuration_latest_revision" {
  description = "Latest revision of the configuration"
  value       = try(aws_msk_configuration.config[0].latest_revision, null)
}
...
output "scram_secret_association_id" {
  description = "Amazon Resource Name (ARN) of the MSK cluster"
  value       = try(aws_msk_scram_secret_association.secret[0].id, null)
}
...
output "log_group_arn" {
  ...
  value       = try(aws_cloudwatch_log_group.cw[0].arn, null)
}
...
output "appautoscaling_policy_arn" {
  ...
  value       = try(aws_appautoscaling_policy.policy[0].arn, null)
}

output "appautoscaling_policy_name" {
  description = "The scaling policy's name"
  value       = try(aws_appautoscaling_policy.policy[0].name, null)
}

output "appautoscaling_policy_policy_type" {
  description = "The scaling policy's type"
  value       = try(aws_appautoscaling_policy.policy[0].policy_type, null)
}
...
output "connect_custom_plugins" {
  ...
  value       = aws_mskconnect_custom_plugin.plugin
}
...
output "connect_worker_configuration_arn" {
  ...
  value       = try(aws_mskconnect_worker_configuration.worker_config[0].arn, null)
}
...
output "connect_worker_configuration_latest_revision" {
  ...
  value       = try(aws_mskconnect_worker_configuration.worker_config[0].latest_revision, null)
}
