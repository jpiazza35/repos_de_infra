...
github_repositories = [
  ...
  "clinician-nexus/app-ps-performance-service",
  "clinician-nexus/app-ps-tenant-service",
  "clinician-nexus/app-ps-settings-service",
  "clinician-nexus/app-ps-productivity-service",
  "clinician-nexus/app-mpt-data",
  "clinician-nexus/app-mpt-e2e-test",
  "clinician-nexus/app-dwb-service",
  "clinician-nexus/app-dwb-ui",
  "clinician-nexus/app-bm-service",
  "clinician-nexus/app-bm-ui",
  "clinician-nexus/data-platform-survey-to-file-type1",
  "clinician-nexus/development-devops-iac",
  "clinician-nexus/app-ps-websocket"
]
eks_provider_urls = [
...
backend_accounts_ids = [
  ...
  "163032254965", # SS_Tools
  "975050241955", # S_DATA_PLATFORM
  "581369176057"  # Management
]
