...
locals {
  s3_bucket_arn = var.create_bucket ? module.bucket[0].bucket_arn : data.aws_s3_bucket.bucket[0].arn
  s3_bucket     = var.create_bucket ? module.bucket[0].bucket_name : data.aws_s3_bucket.bucket[0].bucket
