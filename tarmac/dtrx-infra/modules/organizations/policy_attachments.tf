...
resource "aws_organizations_policy_attachment" "dtcloud_master" {
  policy_id = "p-FullAWSAccess"
  target_id = aws_organizations_account.dtcloud_master.id
}

resource "aws_organizations_policy_attachment" "dtcloud_logging_monitoring" {
  policy_id = "p-FullAWSAccess"
  target_id = aws_organizations_account.dtcloud_logging_monitoring.id
}

resource "aws_organizations_policy_attachment" "dtcloud_security" {
  policy_id = "p-FullAWSAccess"
  target_id = aws_organizations_account.dtcloud_security.id
}

resource "aws_organizations_policy_attachment" "dtcloud_proxy_dev" {
  policy_id = "p-FullAWSAccess"
  target_id = aws_organizations_account.dtcloud_proxy_dev.id
}

resource "aws_organizations_policy_attachment" "dtcloud_proxy_test" {
  policy_id = "p-FullAWSAccess"
  target_id = aws_organizations_account.dtcloud_proxy_test.id
}

resource "aws_organizations_policy_attachment" "dtcloud_proxy_prod" {
  policy_id = "p-FullAWSAccess"
  target_id = aws_organizations_account.dtcloud_proxy_prod.id
}

resource "aws_organizations_policy_attachment" "shared_services" {
  policy_id = "p-FullAWSAccess"
  target_id = aws_organizations_account.dtcloud_shared_services.id
}
...
resource "aws_organizations_policy_attachment" "dtcloud_networking" {
  policy_id = "p-FullAWSAccess"
  target_id = aws_organizations_account.dtcloud_networking.id
}