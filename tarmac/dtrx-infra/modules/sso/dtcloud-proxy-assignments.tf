...
# This sets the AdminPermissionSet to the ProxyDevAdminGroup and links it to the dtcloud-proxy-dev AWS Account
...
# This sets the AdminPermissionSet to the ProxyTestAdminGroup and links it to the dtcloud-proxy-test AWS Account
...
# This sets the AdminPermissionSet to the ProxyProdAdminGroup and links it to the dtcloud-proxy-prod AWS Account
...
# This sets the ReadOnlyPermissionSet to the ProxyTestReadOnlyGroup and links it to the dtcloud-proxy-test AWS Account
...
# This sets the ReadOnlyPermissionSet to the ProxyProdReadOnlyGroup and links it to the dtcloud-proxy-prod AWS Account
