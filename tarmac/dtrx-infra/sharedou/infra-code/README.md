...
This is a terraform repository for the AWS Infra-Code account. It creates and manages the following resources:

- AWS CodeCommit repository for the terraform code
## Tool Versions ##
