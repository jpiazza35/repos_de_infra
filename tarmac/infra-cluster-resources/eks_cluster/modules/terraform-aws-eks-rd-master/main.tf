...
resource "aws_eks_cluster" "this" {
  ...
  #checkov:skip=CKV_AWS_58: "Skipping this check because this is an external module. and we do not manage it"
  #checkov:skip=CKV_AWS_38: "Skipping this check because this is an external module. and we do not manage it"
  #checkov:skip=CKV_AWS_37: "Skipping this check because this is an external module. and we do not manage it"
...
resource "aws_cloudwatch_log_group" "this" {
  ...
  #checkov:skip=CKV_AWS_338: "Skipping this check because this is an external module. and we do not manage it"
...
resource "aws_security_group" "cluster" {
  ...
  #checkov:skip=CKV2_AWS_5: "Skipping this check because this is an external module. and we do not manage it"
