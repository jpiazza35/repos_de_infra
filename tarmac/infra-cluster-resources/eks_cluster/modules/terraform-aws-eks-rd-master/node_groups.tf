...
data "aws_iam_policy_document" "cni_ipv6_policy" {
  ...
  #checkov:skip=CKV_AWS_111: "Skipping this check because this is an external module. and we do not manage it"
  #checkov:skip=CKV_AWS_356: "Skipping this check because this is an external module. and we do not manage it"
  statement {
    sid = "AssignDescribe"
    actions = [
