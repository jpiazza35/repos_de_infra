...
resource "aws_launch_template" "this" {
  count = var.create && var.create_launch_template ? 1 : 0
  #checkov:skip=CKV_AWS_79: "Skipping this check because this is an external module. and we do not manage it"
  #checkov:skip=CKV_AWS_341: "Skipping this check because this is an external module. and we do not manage it"
