...
iam_roles = [
  {
    ...
    rolename = "AWSReservedSSO_AWSAdministratorAccess_d65cf6bdfb296011"
    groups   = ["system:masters"]
  },
  {
    rolearn  = "arn:aws:iam::071766652168:role/AWSReservedSSO_PowerUserAccess_68599fc0a749f446"
    rolename = "AWSReservedSSO_PowerUserAccess_68599fc0a749f446"
    groups   = ["system:masters"]
  }
]
...
incumbent_api_sa_annotation = "arn:aws:iam::993562814415:role/p_eks_oidc_role"
...
argocd_preview_environment         = "preview"
...
ingress_mpt_host                           = "mpt.cliniciannexus.com"
ingress_mpt_preview_host                   = "mpt.preview.cliniciannexus.com"
ingress_argocd_host                        = "argocd.cliniciannexus.com"
ingress_monitoring_host                    = "monitoring.cliniciannexus.com"
...
ingress_k8s_dashboard_host                 = "k8s.cliniciannexus.com"
...
ingress_ps_name                      = "ps"
ingress_ps_host                      = "ps.cliniciannexus.com"
...
ingress_kubecost_host      = "kubecost.cliniciannexus.com"
