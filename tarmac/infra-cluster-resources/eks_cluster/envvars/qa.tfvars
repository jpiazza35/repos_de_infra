...
iam_roles = [
  {
    ...
    rolename = "AWSReservedSSO_AWSAdministratorAccess_744f002ac69e113e"
    groups   = ["system:masters"]
  },
  {
    rolearn  = "arn:aws:iam::063890802877:role/AWSReservedSSO_PowerUserAccess_595d074b754dff97"
    rolename = "AWSReservedSSO_PowerUserAccess_595d074b754dff97"
    groups   = ["system:masters"]
  }
]
...
mpt_namespace               = "mpt"
incumbent_api_sa_annotation = "arn:aws:iam::679687097709:role/q_eks_oidc_role"
...
ingress_mpt_host                           = "mpt.qa.cliniciannexus.com"
ingress_mpt_preview_host                   = "" #it is just for prod that why it is empty
ingress_argocd_host                        = "argocd.qa.cliniciannexus.com"
ingress_monitoring_host                    = "monitoring.qa.cliniciannexus.com"
...
ingress_k8s_dashboard_host                 = "k8s.qa.cliniciannexus.com"
...
ingress_ps_name                      = "ps"
ingress_ps_host                      = "ps.qa.cliniciannexus.com"
...
ingress_kubecost_host      = "kubecost.qa.cliniciannexus.com"
